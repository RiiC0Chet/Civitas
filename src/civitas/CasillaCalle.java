...
public class CasillaCalle extends Casilla {
    ...
    protected float precioCompra, precioEdificar, precioBaseAlquiler;
    protected int numCasas, numHoteles;

    protected static final float FACTORALQUILERCALLE = 1.0f, FACTORALQUILERCASA = 1.0f, FACTORALQUILERHOTEL = 4.0f;
